...
class ActionController::Base
  module Apipie::ControllerValidationHelpers
    ...
    def schema_validation_errors_for_response
      unprocessed_schema = Apipie::json_schema_for_method_response(self.class.controller_name, action_name, response.code, true, Apipie.app.controller_versions(self.class).first)
